...
const BUILTIN = {
  ...
  "💻 IT": [
    ...
    "Константа", "Функція", "Метод", "Клас", "Модуль", "Пакет", "Запит", "Відповідь", "Помилка", "Вразливість",
    "Хакер", "Фішинг", "Спам", "Бот", "Нейромережа", "Інтелект", "Дані", "Аналітика", "Таблиця", "Сортування",
    "Пошук", "Фільтр", "Індекс", "Трафік", "Пинг", "Шлюз", "Маска", "Адреса"
  ],
  "🎬 Кіно": [
    ...
    "Фінал", "Титри", "Кадр", "Дубль", "Реквізит", "Костюм", "Гримерка", "Освітлення", "Мікрофон", "Екран",
    "Проектор", "Квиток", "Афіша", "Рейтинг", "Критик", "Продюсер", "Кіностудія", "Голлівуд", "Фестиваль", "Кінофестиваль",
    "Статуетка", "Червона доріжка", "Зірка", "Фанат", "Автограф", "Кастинг", "Роль", "Епізод", "Масовка", "Камео",
    "Ремейк", "Сиквел", "Приквел", "Трилогія", "Сага", "Екранізація", "Блокбастер", "Бойовик", "Трилер", "Жахи",
    "Фентезі", "Детектив", "Мелодрама", "Мюзикл", "Байопік", "Документалка", "Артхаус", "Короткометражка", "Анімація", "Графіка",
    "Хромакей", "Об'єктив", "Штатив", "Фокус", "Звук", "Музика", "Композитор", "Монтажер", "Сценарист", "Гример",
    "Художник", "Постановник", "Директор", "Агент", "Премія", "Номінація"
  ],
  "🍕 Їжа": [
  ...
  "🏅 Спорт": [
    ...
    "Батут", "Скейтборд", "Серфінг", "Сноуборд", "Лижі", "Ковзани", "Ролики", "Шлем", "Ласти", "Жилет",
    "Весло", "Човен", "Вітрило", "Парашут", "Планер", "Байдарка", "Каное", "Кінь", "Сідло", "Жокей",
    "Іподром", "Трек", "Корт", "Ринг", "Татамі", "Сітка", "Ворота", "Кошик", "Кільце", "М'яч",
    "Бита", "Ключка", "Перчатки", "Бутси", "Кеди", "Майка", "Шорти", "Кубок", "Медаль", "Диплом",
    "Рекорд", "Тренер", "Команда", "Гравець", "Капітан", "Гол", "Пас", "Старт", "Фініш", "Перемога",
    "Нічия", "Поразка", "Турнір", "Чемпіонат", "Олімпіада", "Спортзал", "Басейн", "Ковзанка", "Йога"
  ],
  "🎓 Школа": [
    "Журнал", "Канікули", "Перерва", "Щоденник", "Лінійка", "Циркуль", "Атлас", "Формула", "Теорема", "Твір",
    "Диктант", "Лабораторна", "Крейда", "Дошка", "Парта", "Дзвінок", "Атестат", "Ректор", "Конспект", "Шпаргалка",
    "Факультатив", "Екзамен", "Аудиторія", "Підручник", "Олівець", "Ручка", "Маркер", "Гумка", "Точилка", "Зошит",
    "Альбом", "Фарби", "Пензлик", "Клей", "Ножиці", "Картон", "Папір", "Степлер", "Дірокол", "Папка",
    "Файл", "Портфель", "Стипендія", "Лекція", "Семінар", "Курсова", "Дипломна", "Аспірант", "Професор", "Доцент",
    "Декан", "Кафедра", "Факультет", "Університет", "Коледж", "Ліцей", "Гімназія", "Учень", "Школяр", "Студент",
    "Випускник", "Вчитель", "Викладач", "Куратор", "Група", "Потік", "Урок", "Пара", "Розклад", "Оцінка",
    "Бал", "Залік", "Практика", "Чернетка", "Читалка", "Абонемент", "Словник", "Довідник", "Енциклопедія", "Правило",
    "Аксіома", "Гіпотеза", "Доказ", "Задача", "Приклад", "Вправа", "Питання", "Доповідь", "Реферат", "Проєкт",
    "Презентація", "Екскурсія"
  ],
  "🕺 Хобі": [
    "Дайвінг", "Орігамі", "Скрапбукінг", "Покер", "Косплей", "Вініл", "Фотополювання", "Нумізматика", "Квест", "Стрільба з лука",
    "Графіті", "Моделювання", "В'язання", "Вишивання", "Кераміка", "Садівництво", "Блогерство", "Подкаст", "Скелелазіння", "Риболовля",
    "Полювання", "Кулінарія", "Дегустація", "Боулінг", "Дартс", "Настільні ігри", "Пазли", "Філателія", "Бонсай", "Астрономія",
    "Металошукач", "Реставрація", "Картинг", "Пейнтбол", "Страйкбол", "Фрізбі", "Фокуси", "Жонглювання", "Миловаріння", "Плетіння",
    "Гончарство", "Петриківка", "Малювання", "Квілінг", "Печворк", "Флористика", "Гербарій", "Каліграфія", "Різьблення", "Чеканка",
    "Випалювання", "Авіамоделювання", "Судомоделювання", "Робототехніка", "Радіоаматор", "Дизайн", "Шиття", "Макіяж", "Манікюр", "Татуювання",
    "Пірсинг", "Етнографія", "Краєзнавство", "Генеалогія", "Волонтерство", "Благодійність", "Подорожі", "Хайкінг", "Трекінг", "Кемпінг",
    "Спелеологія", "Сплав", "Рафтинг", "Віндсерфінг", "Кайтсерфінг", "Парапланеризм", "Роупджампінг", "Паркур", "Трюки", "Йо-йо",
    "Спіннер", "Кубик Рубіка", "Колекціонування", "Антикваріат", "Вітраж", "Мозаїка", "Гра на гітарі", "Танці", "Балет", "Стретчинг",
    "Медитація", "Скрайбінг", "Комікси", "Манга", "Аніме"
  ],
  "🎸 Музика": [
    "Ритм", "Соло", "Синтезатор", "Кавер", "Плейлист", "Репетиція", "Саундтрек", "Метроном", "Акорд", "Джаз",
    "Диригент", "Барабан", "Тромбон", "Саксофон", "Флейта", "Арфа", "Гобой", "Кларнет", "Віолончель", "Контрабас",
    "Альт", "Орган", "Баян", "Акордеон", "Гармошка", "Бандура", "Сопілка", "Бубон", "Рояль", "Піаніно",
    "Клавесин", "Бек-вокал", "Опера", "Оперета", "Рок", "Поп", "Реп", "Метал", "Блюз", "Кантрі",
    "Фолк", "Техно", "Дабстеп", "Ембієнт", "Шансон", "Реггі", "Панк", "Ноти", "Скрипковий ключ", "Гама",
    "Мажор", "Мінор", "Темп", "Гучність", "Еквалайзер", "Колонки", "Навушники", "Плеєр", "Магнітофон", "Підсилювач",
    "Студія", "Лейбл", "Кліп", "Текст", "Мелодія", "Гармонія", "Аранжування", "Оркестр", "Хор", "Ансамбль",
    "Квартет", "Дует", "Тріо", "Тур", "Концерт", "Гастролі", "Райдер", "Куліси", "Партер", "Ложа",
    "Амфітеатр", "Галерка", "Біс", "Овація", "Групі", "Вінілова платівка", "Касета", "Диск", "Стрімінг", "Хіт",
    "Шлягер"
  ],
  "🏛️ Культура": [
    "Колізей", "Сакура", "Сомбреро", "Фіорд", "Стоунхендж", "Ейфелева вежа", "Черепиця", "Гейша", "Кілт", "Гондола",
    "Пагода", "Сафарі", "Вігвам", "Юрта", "Ранчо", "Фазенда", "Шале", "Хмарочос", "Площа", "Ратуша",
    "Пам'ятник", "Фреска", "Статуя", "Скульптура", "Галерея", "Виставка", "Експонат", "Артефакт", "Руїни", "Сфінкс",
    "Храм", "Собор", "Мечеть", "Костел", "Синагога", "Традиція", "Обряд", "Свято", "Ярмарок", "Кухня",
    "Делікатес", "Прянощі", "Вишиванка", "Кімоно", "Сарі", "Пончо", "Тюрбан", "Тотем", "Легенда", "Міф",
    "Казка", "Епос", "Мова", "Діалект", "Акцент", "Етикет", "Церемонія", "Калліграфія", "Орнамент", "Візерунок",
    "Ремесло", "Ткацтво", "Ковальство", "Народ", "Плем'я", "Нація", "Держава", "Столиця", "Гімн", "Валюта",
    "Кордон", "Митниця", "Віза", "Паспорт", "Турист", "Подорож", "Гід", "Сувенір", "Листівка", "Магнітик",
    "Хостел", "Круїз", "Політ", "Трансфер"
  ],
  "🛋️ Побут": [
    "Шарнір", "Дуршлаг", "Пуф", "Жалюзі", "Подовжувач", "Скарбничка", "Штопор", "Серветка", "Торшер", "Ополоник",
    "Гамак", "Праска", "Пилосос", "Вішалка", "Комод", "Карниз", "Люстра", "Бра", "Скатертина", "Рушник",
    "Фіранка", "Прищіпка", "Губка", "Мильниця", "Гребінець", "Фен", "Бритва", "Таз", "Відро", "Швабра",
    "Віник", "Совок", "Терка", "Деко", "Друшляк", "Ситечко", "Чайник", "Каструля", "Сковорідка", "Черпак",
    "Лопатка", "Віничок", "Ніж", "Виделка", "Ложка", "Тарілка", "Чашка", "Стакан", "Келих", "Глечик",
    "Термос", "Фольга", "Пергамент", "Плівка", "Пральний порошок", "Кондиціонер", "Мило", "Шампунь", "Зубна паста", "Щітка",
    "Вата", "Пластир", "Бинт", "Перекис", "Голка", "Нитка", "Гудзик", "Булавка", "Наперсток", "П'яльця",
    "Вимірювальна стрічка", "Рівень", "Рулетка", "Викрутка", "Плоскогубці", "Наждачка", "Дриль", "Шуруп", "Цвях", "Дюбель",
    "Сокира", "Пила", "Драбина", "Ліхтарик", "Батарейка", "Зарядка", "Перехідник", "Розетка", "Вимикач", "Домофон",
    "Килимок"
  ],
  "🚗 Транспорт": [
    ...
    "Фура", "Пікап", "Позашляховик", "Лімузин", "Мікроавтобус", "Карета", "Сани", "Віз", "Катамаран", "Пліт",
    "Баржа", "Танкер", "Криголам", "Гідроцикл", "Мотор", "Штурвал", "Пропелер", "Шасі", "Крило", "Кабіна",
    "Салон", "Багажник", "Капот", "Фара", "Бампер", "Кермо", "Педаль", "Гальма", "Шина", "Акумулятор",
    "Радіатор", "Глушник", "Бензобак", "Двигун", "Коробка передач", "Спідометр", "Навігатор", "Відеореєстратор", "Парктронік", "Автокрісло",
    "Гараж", "Парковка", "Заправка", "Шосе", "Траса", "Естакада", "Тунель", "Міст", "Переїзд", "Світлофор",
    "Зебра", "Тротуар", "Узбіччя", "Водій", "Пілот", "Машиніст", "Кондуктор", "Контролер", "Пасажир", "Жетон",
    "Проїзний", "Рейс", "Маршрут", "Графік", "Зупинка", "Вокзал", "Перон", "Аеропорт", "Причал", "Депо"
  ],
  "🐾 Дика природа": [
    ...
    "Краб", "Омар", "Креветка", "Морська зірка", "Морський коник", "Акула", "Кит", "Кашалот", "Морж", "Нерпа",
    "Пінгвін", "Альбатрос", "Пелікан", "Чапля", "Лелека", "Журавель", "Орел", "Яструб", "Сокіл", "Сова",
    "Пугач", "Дятел", "Зозуля", "Соловей", "Шишка", "Хвоя", "Мох", "Лишайник", "Папороть", "Очерет",
    "Ліана", "Орхідея", "Едельвейс", "Магнолія", "Кипарис", "Кедр", "Ялина", "Смерека", "Мурашник", "Вулик",
    "Нора", "Барліг", "Гніздо", "Дупло", "Слід", "Кігті", "Ікла", "Хвіст"
  ],
  "💡 Дії та емоції": [
    ...
    "Смакувати", "Нюхати", "Торкатися", "Варити", "Мити", "Прати", "Працювати", "Відпочивати", "Подорожувати", "Вигадувати",
    "Планувати", "Виконувати", "Керувати", "Підкорятися", "Вчити", "Вчитися", "Пояснювати", "Розуміти", "Забувати"
  ],
  "🎮 Ігри та меми": [
    "Стрім", "Скін", "Гільдія", "Лутбокс", "Спідран", "Фейспалм", "Чіт-код", "Нуб", "Пасхалка", "Кріпер",
    "Хедшот", "Скріншот", "Донат", "Бос", "Левел", "Мана", "Хілер", "Танк", "Рейд", "Крафт",
    "Інвентар", "Маунт", "Ніп", "Локація", "Сейв", "Фраг", "Лаг", "Пінг", "Бан", "Мультиплеєр",
    "Кооператив", "Джойстик", "Геймпад", "Віртуальна реальність", "Стрімер", "Чат", "Емодзі", "Смайл", "Хайп", "Крінж",
    "Троль", "Хейтер", "Фолловер", "Саб", "Лайк", "Репост", "Тег", "Влог", "Челендж", "Мем",
    "Стікер", "Гіфка", "Аватар", "Нікнейм", "Профіль", "Аккаунт", "Пароль", "Логін", "Підписка", "Сповіщення",
    "Топ", "Про", "Твінк", "Агро", "Бафф", "Дебафф", "Гір", "Тіма", "Рандом", "Кікнути",
    "Забанити", "Замутити", "Лівер", "Фідити", "Ганк", "Скіл", "Ульта", "Кулдаун", "Респаун", "Вайп",
    "Чекпоінт", "Ачівка", "Платина", "Геймер", "Задрот", "Комп'ютерний клуб", "Кіберспорт", "Приз", "Коментатор", "Аналітик",
    "Конвент", "Комікс"
  ],
  "💼 Робота": [
    "Дедлайн", "Оффер", "Кава-брейк", "Аванс", "Стартап", "Податок", "Фріланс", "Коворкінг", "Інвестиція", "Вакансія",
    "Корпоратив", "Звіт", "Нарада", "Прибуток", "Збиток", "Маркетинг", "Реклама", "Бренд", "Логотип", "Клієнт",
    "Замовник", "Партнер", "Конкурент", "Продажі", "Логістика", "Склад", "Офіс", "Кабінет", "Стіл", "Стілець",
    "Ксерокс", "Печатка", "Підпис", "Договір", "Контракт", "Угода", "Акція", "Облігація", "Банк", "Рахунок",
    "Картка", "Кредит", "Депозит", "Відсотки", "Біржа", "Брокер", "Менеджер", "Секретар", "Бухгалтер", "Юрист",
    "Економіст", "Аудит", "Податки", "Штраф", "Зарплата", "Відпустка", "Лікарняний", "Відрядження", "Кар'єра", "Підвищення",
    "Звільнення", "Резюме", "Співбесіда", "Стажування", "Досвід", "Навички", "Лідер", "Делегація", "Планування", "Стратегія",
    "Тактика", "Результат", "Якість", "Термін", "Завдання", "Пріоритет", "Ефективність", "Продуктивність", "Тайм-менеджмент", "Стрес",
    "Нетворкінг", "Переговори", "Ділова зустріч", "Візитка", "Портфоліо", "Кейс", "Фідбек", "Коучинг", "Тренінг", "Вебінар"
  ],
  "🧘 Психологія": [
    "Інтуїція", "Пульс", "Темперамент", "М'яз", "Рефлекс", "Фобія", "Осанка", "Імунітет", "Харизма", "Совість",
    "Комплекс", "Ейфорія", "Інстинкт", "Свідомість", "Підсвідомість", "Емпатія", "Агресія", "Меланхолія", "Флегматик", "Сангвінік",
    "Холерик", "Екстраверт", "Інтроверт", "Скелет", "Суглоб", "Хребет", "Серце", "Легені", "Печінка", "Нирки",
    "Шлунок", "Мозок", "Нерв", "Кров", "Судина", "Гормон", "Адреналін", "Дофамін", "Серотонін", "Сон",
    "Безсоння", "Галюцинація", "Пам'ять", "Увага", "Талант", "Геній", "Фантазія", "Логіка", "Аналіз", "Синтез",
    "Сприйняття", "Відчуття", "Екстаз", "Депресія", "Шок", "Травма", "Фрустрація", "Катарсис", "Інсайт", "Мотивація",
    "Воля", "Звичка", "Залежність", "Его", "Нарцисизм", "Альтруїзм", "Гумор", "Посмішка", "Сльоза", "Поцілунок",
    "Обійми", "Погляд", "Голос", "Жест", "Міміка", "Зріст", "Вага", "Фігура", "Мускулатура", "Гнучкість",
    "Дихання", "Температура", "Тиск", "Генетика", "ДНК", "Шкіра", "Волосся", "Нігті", "Очі", "Вуха",
    "Ніс", "Язик", "Зуби", "Підборіддя", "Потилиця"
  ],
  "🎞️ Ностальгія": [
    "Тамагочі", "Пейджер", "Тетріс", "Жуйка", "Денді", "Дискотека", "Полароїд", "Діафільм", "Відеомагнітофон", "Прокат",
    "Фішки", "Кепси", "Пружинка", "Радуга", "Антена", "Слайди", "Негатив", "Фотолабораторія", "Анкета", "Друзі",
    "Приставка", "Картридж", "Дроти", "Телефонна будка", "Автомат", "Сифон", "Морозиво", "Юпі", "Зуко", "Турбо",
    "Лав із", "Наклейки", "Плакат", "Постер", "Парабелум", "Кіндер", "Колекція", "Обмін", "Рінгтон", "Ік-порт",
    "Блютуз", "Айсік'ю", "Форум", "Флешка", "Дискета", "Зв'язок", "Поповнення", "Скретч-карта", "Ваучер", "Перемотка",
    "Батарейки", "Пружина", "Змійка", "Маріо", "Танчики", "Контра", "Мортал Комбат", "Покемони", "Сейлор Мун", "Телепузики",
    "Барбі", "Лего", "Пазл", "Скакалка", "Резинка", "Класики", "Хованки", "Квач", "Козаки-розбійники", "Футбол",
    "Двір", "Дружба"
  ],
  "🔞 Пікантне": [
    "Стриптиз", "Похмілля", "Флірт", "Побачення", "Декольте", "Купідон", "Масаж", "Текіла", "Коктейль", "Бармен",
    "Вечірка", "Клуб", "Караоке", "Кальян", "Шампанське", "Вино", "Коньяк", "Горілка", "Пиво", "Закуска",
    "Тост", "Драйв", "Знайомство", "Номер", "Повідомлення", "Селфі", "Інстаграм", "Коментар", "Ефект", "Подарунок",
    "Квіти", "Троянди", "Вечеря", "Ресторан", "Вид", "Дах", "Захід", "Світанок", "Прогулянка", "Таксі",
    "Квартира", "Світло", "Тінь", "Тиша", "Ліжко", "Мрія", "Бажання", "Кохання", "Дотик", "Шепіт",
    "Запах", "Парфуми", "Смак", "Секрет", "Таємниця", "Інтим", "Довіра", "Щирість", "Вірність", "Зрада",
    "Ранок", "Сніданок", "Усмішка", "Щастя", "Доля", "Шанс", "Ризик", "Гра"
  ],
  "🇬🇧 English Light": [
    ...
    "Butter", "Cheese", "Sugar", "Salt", "Tea", "Coffee", "Milk", "Juice", "Chicken", "Meat",
    "Egg", "Potato", "Tomato", "Onion", "Soup", "Cake", "Sweet", "Plate", "Cup", "Spoon",
    "Fork", "Knife", "Bottle", "Glass", "Kitchen", "Bathroom", "Bedroom", "Door", "Window", "Wall",
    "Floor", "Roof", "Garden", "Park", "Forest", "Mountain", "River", "Sea", "Beach", "Lake",
    "Star", "Earth", "World", "Map", "Way", "Road", "Bridge", "Bus", "Car", "Bike",
    "Train", "Plane", "Ship", "Boat", "Ticket", "Bag", "Pocket", "Shirt", "Pants", "Dress",
    "Skirt", "Hat", "Shoe", "Sock", "Coat", "Gloves", "Watch", "Pen", "Pencil", "Paper",
    "Notebook", "Letter", "Picture", "Camera", "Radio", "Clock", "Lamp", "Bed", "Box", "Gift",
    "Toy", "Ball", "Doll", "Card", "Key", "Coin", "Flag", "King", "Queen", "Hero",
    "Police", "Worker", "Farmer", "Driver", "Pilot", "Captain", "Player", "Large", "Long", "Short",
    "Tall", "Thin", "Fat", "Rich", "Poor", "Young", "Beautiful", "Ugly", "Clean", "Dirty",
    "Easy", "Hard", "Right", "Wrong", "True", "False", "Wait", "Stop", "Go", "Come",
    "Sit", "Stand", "Fly", "Fall", "Break", "Fix", "Find", "Lose", "Buy", "Sell",
    "Pay", "Cost", "Win", "Try", "Ask", "Answer", "Call", "Tell", "Say", "Draw",
    "Paint", "Build", "Wash", "Cook", "Bake", "Listen", "Hear", "Feel", "Think", "Know",
    "Mean", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday", "Week", "Month",
    "Year", "Spring", "Autumn", "Weather", "Storm", "Ice", "Fire", "Smoke", "Dust", "Left",
    "Top", "Bottom", "Front", "Back", "Side", "Middle", "Corner", "Center", "Airport", "Actor",
    "Address", "Adult", "Afternoon", "Airplane", "Area", "Arm", "Aunt", "Baby", "Bank", "Basketball",
    "Bath", "Beard", "Beer", "Bell", "Bill", "Birthday", "Biscuit", "Brother", "Cafe", "Camping",
    "Carrot", "Cartoon", "Cat", "Chess", "Chocolate", "Class", "Clothes", "Cookie", "Cousin", "Cow",
    "Credit card", "Dad", "Dance", "Date", "Daughter", "Desk", "Diary", "Dictionary", "Dinner", "Dinosaur",
    "Dish", "Dog", "Dollar", "Double", "Early", "East", "Elephant", "Email", "End", "Engine",
    "Evening", "Everywhere", "Example", "Factory", "Farm", "Father", "Favorite", "Field", "Film", "Finger",
    "Food", "Football", "Fruit", "Funny", "Gas", "Glove", "Goal", "Gold", "Grass", "Group",
    "Guitar", "Hair", "Half", "Hall", "Health", "Heavy", "Hello", "Hobby", "Holiday", "Home",
    "Horse", "Hospital", "Hotel", "Hour", "Hungry", "Husband", "Idea", "Island", "Jacket", "Jam",
    "Jeans", "Job", "Kite", "Language", "Laptop", "Last", "Laugh", "Leaf", "Leg", "Lesson",
    "Library", "Light", "Line", "Lion", "Lip", "List", "Lunch", "Machine", "Magazine"
  ],
  "🇬🇧 English": [
    ...
    "Engage", "Enhance", "Enjoyment", "Enormous", "Ensure", "Entertain", "Enthusiasm", "Entire", "Entrance", "Environment",
    "Episode", "Equal", "Equip", "Equipment", "Error", "Escape", "Essential", "Establish", "Estimate", "Ethical",
    "Evaluate", "Event", "Evidence", "Evolution", "Exaggerate", "Examine", "Exceed", "Excellent", "Exception", "Exchange",
    "Excite", "Exclude", "Excuse", "Execute", "Exercise", "Exhaust", "Exhibit", "Exist", "Expand", "Expect",
    "Expense", "Experience", "Experiment", "Expert", "Explain", "Explore", "Export", "Expose", "Express", "Extend",
    "External", "Extra", "Extract", "Extreme", "Facility", "Factor", "Failure", "Faith", "Familiar", "Famous",
    "Fancy", "Fantastic", "Fashion", "Fatal", "Fault", "Favor", "Fear", "Feature", "Federal", "Fee",
    "Feedback", "Fellow", "Female", "Fence", "Festival", "Fetch", "Fiber", "Fiction", "Fierce", "Fight",
    "Figure", "File", "Filter", "Final", "Finance", "Finding", "Finish", "Firm", "First", "Fiscal",
    "Fisher", "Fitness", "Flame", "Flash", "Flat", "Flavor", "Flee", "Fleet", "Flesh", "Flexible",
    "Flight", "Float", "Flood", "Flow", "Fluid", "Focus", "Fold", "Follow", "Fond", "Fool",
    ...
    "Gentle", "Genuine", "Gesture", "Global", "Glory", "Gossip", "Govern", "Grace", "Grade", "Gradual",
    "Graduate", "Grain", "Grammar", "Grand", "Grant", "Graphic", "Grateful", "Gravity", "Great", "Greed",
    "Grief", "Grocery", "Ground", "Growth", "Guarantee", "Guard", "Guess", "Guidance", "Guide", "Guilty",
    "Habit", "Handle", "Happen", "Harbor", "Hardly", "Harmful", "Harmony", "Harvest", "Hatred", "Hazard",
    "Hearing", "Heaven", "Height", "Heritage", "Hesitate", "Hidden", "Highlight", "Highly", "Highway", "History",
    "Hollow", "Honest", "Honor", "Horizon", "Horror", "Host", "Hostile", "Household", "Housing", "Huge",
    "Human", "Humble", "Humor", "Hunger", "Hunter", "Hurry", "Identify", "Ignore", "Illegal", "Illness",
    "Image", "Imagine", "Immediate", "Impact", "Imply", "Import"
  ],
  "🇬🇧 English Hardcore": [
    ...
    "Feckless", "Fiduciary", "Filibuster", "Gauche", "Gerrymander", "Hubris", "Hypotenuse", "Impeach", "Incognito", "Incontrovertible",
    "Inculcate", "Infrastructure", "Interpolate", "Irony", "Jejune", "Kowtow", "Laissez-faire", "Lexicon", "Loquacious", "Lugging",
    "Metamorphosis", "Moiety", "Nanotechnology", "Nihilism", "Nomenclature", "Nonsectarian", "Notarize", "Omnipotent", "Oxidize", "Paleontology",
    "Parameter", "Pecuniary", "Photosynthesis", "Plagiarize", "Plasma", "Polymer", "Precipice", "Quasar", "Recapitulate", "Reciprocal",
    "Reparation", "Respiration", "Soliloquy", "Subjugate", "Suffragist", "Supercilious", "Tautology", "Taxonomy", "Tectonic", "Tempestuous",
    "Thermodynamics", "Totalitarian", "Unctuous", "Usurp", "Vehement", "Vortex", "Winnow", "Wrought", "Xenophobe", "Ziggurat",
    "Abstain", "Adversary", "Altruism", "Amicable", "Anecdote", "Animosity", "Antagonism", "Antiseptic", "Apathy", "Apocryphal",
    "Apparition", "Arbitrary", "Archaic", "Ardor", "Arrogance", "Articulate", "Artifice", "Asperity", "Aspiration", "Assail",
    "Assertion", "Astute", "Atrocity", "Atrophy", "Attenuate", "Audacious", "Augment", "Auspicious", "Austere", "Authentic",
    "Authoritarian", "Autonomy", "Aversion", "Baffle", "Banal", "Banality", "Benevolent", "Benign", "Berate", "Bereft",
    "Bewilder", "Blatant", "Blight", "Boisterous", "Bombastic", "Boorish", "Braggart", "Brevity", "Brusque", "Buffoon",
    "Bulwark", "Burgeon", "Cacophony", "Candid", "Capricious", "Carnage", "Castigate", "Catalyst", "Catharsis", "Caustic",
    "Censure", "Chastise", "Cherish", "Chivalry", "Choleric", "Chronicle", "Cipher", "Clairvoyant", "Clandestine", "Clemency",
    "Coalesce", "Coerce", "Coherent", "Cohesive", "Collaborate", "Colloquial", "Collusion", "Commemorate", "Commendable", "Commensurate",
    "Compassion", "Compatible", "Compelling", "Compendium", "Complacent", "Complement", "Compliance", "Composure", "Compromise", "Compulsion",
    "Compunction", "Concede", "Conceit", "Conception", "Conciliatory", "Concise", "Conclusive", "Condone", "Conducive", "Confluence",
    "Conformity", "Confound", "Congenial", "Congregation", "Conjecture", "Conjure", "Connoisseur", "Conscientious", "Consecrate", "Consensus",
    "Consolation", "Consolidate", "Conspicuous", "Constituent", "Constraint", "Consummate", "Contemplation", "Contemporary", "Contempt", "Contentious",
    "Contingent", "Contortion", "Contraband", "Contradict", "Contravention", "Contrition", "Contrived", "Controversial", "Conundrum", "Convergence",
    "Conviction", "Copious", "Cordial", "Corollary", "Corroborate", "Corrosive", "Cosmopolitan", "Counsel", "Counterfeit", "Counterpart",
    "Covenant", "Covert", "Cower", "Crafty", "Craven", "Credence", "Credible", "Credulity", "Criterion", "Crucial",
    "Cryptic", "Culpable", "Culminate", "Cultivate", "Cumbersome", "Cunning", "Cursory", "Curtail", "Cynic", "Dally",
    "Daunt", "Dauntless", "Debase", "Debilitate", "Debunk", "Decorum", "Decry", "Deference", "Defiant", "Deficit",
  ...
  "🇺🇦 Відомі Українці": [
    ...
    "Дмитро Носов", "Богдан Буше", "Женя Галич", "Саша Бо", "Тетяна Песик", "Руслан Ханумак", "Віталій Сап'янич", "Олександр Венгеренко", "Юлія Паєвська", "Василь Сліпак",
    "Петро Григоренко", "Мустафа Джемілєв", "Рефат Чубаров", "Ахтем Сеітаблаєв", "Наріман Джелял", "Емір-Усеїн Куку", "Олександр Кольченко", "Роман Ратушний"
  ],
  "🌟 Світові Зірки": [
...
// Повертає всі слова категорії (дедублікація вже зроблена у BUILTIN)
function getCategoryWords(catName) {
  return BUILTIN[catName] || [];
}
...
function initCreateUI() {
  ...
  // Категорії з підкатегоріями і кнопками виділення
  const grid = $("categories-grid");
  grid.innerHTML = "";

  // Глобальні кнопки
  const globalBtns = document.createElement("div");
  globalBtns.className = "cat-global-btns";
  globalBtns.innerHTML = `
    <button class="btn-cat-all" id="cat-select-all">✅ Всі</button>
    <button class="btn-cat-all" id="cat-deselect-all">☐ Жодної</button>
  `;
  grid.appendChild(globalBtns);

  // Чекбокс для кожної категорії
  const UNSAFE = ["🔞 Пікантне"];
  Object.keys(BUILTIN).forEach(cat => {
    const count = BUILTIN[cat].length;
    const defaultOn = !UNSAFE.includes(cat);
    const lbl = document.createElement("label");
    lbl.className = "cat-checkbox";
    lbl.innerHTML = `<input type="checkbox" class="cat-cb" value="${cat}" ${defaultOn ? "checked" : ""}> ${cat} <span class="sub-count">(${count})</span>`;
    grid.appendChild(lbl);
  });

  $("cat-select-all").onclick = () =>
    grid.querySelectorAll(".cat-cb").forEach(cb => cb.checked = true);
  $("cat-deselect-all").onclick = () =>
    grid.querySelectorAll(".cat-cb").forEach(cb => cb.checked = false);
...
function buildWordPool() {
  ...
  let pool = [];
  if (tab === "categories") {
    // Збираємо слова з обраних підкатегорій (дедублікуємо)
    const seen = new Set();
    document.querySelectorAll("#categories-grid .cat-cb:checked").forEach(cb => {
      getCategoryWords(cb.value).forEach(w => {
        if (!seen.has(w)) { seen.add(w); pool.push(w); }
      });
    });
  } else if (tab === "custom") {
    const seen = new Set();
    $("custom-words").value.split(/[\n,]+/).map(s => s.trim()).filter(Boolean)
      .forEach(w => { if (!seen.has(w)) { seen.add(w); pool.push(w); } });
  } else {
    const seen = new Set();
    jsonWords.forEach(w => { if (!seen.has(w)) { seen.add(w); pool.push(w); } });
  }
